...
public final class QueryUtils {
    ...
    public static ArrayList<EarthquakeItem> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray earquakesArray = baseJsonResponse.getJSONArray("features");

            //Loop through each feature in the array
            for (int i=0; i<earquakesArray.length(); i++) {
                ...
                EarthquakeItem newEarthQuake = new EarthquakeItem(mag,place, time);
